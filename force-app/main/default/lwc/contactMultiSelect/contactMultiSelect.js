...
import getResults from '@salesforce/apex/contactMultiSelectController.getResults';

export default class ContactMultiSelect extends LightningElement {
    ...
    searchField(event) {
        ...
        getResults({ ObjectName: this.objectName, fieldName: this.fieldName, phone: this.phone, value: currentText, selectedRecId : selectRecId })
        .then(result => {
   ...
   setSelectedRecord(event) {
        ...
        let newsObject = { 'recId' : recId ,'recName' : selectName, 'recPhone' : selectPhone };
